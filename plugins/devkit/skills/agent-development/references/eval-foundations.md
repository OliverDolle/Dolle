...
looked fine" is not measurement. This reference is about picking the **right signal** before
...
- `llm-as-judge.md` — how to score the subjective criteria named in §0.
- `eval-harness-ci.md` — turn this dataset into a merge gate.
- `tracing-observability.md` — capture the traces trajectory + online eval need.
- `workflow-design.md` — build the agent this reference measures.
