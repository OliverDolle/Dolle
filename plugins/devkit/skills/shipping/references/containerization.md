...
- `kubernetes.md` — running these images in production (deployments, probes, resources,
...
- `cloud-infrastructure.md` — building/scanning images in CI, pushing to a registry, and IaC
  around the cluster.
