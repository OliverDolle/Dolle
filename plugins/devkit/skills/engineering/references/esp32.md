...
- `systematic-debugging.md` — the reset-reason → backtrace → core-dump flow here is exactly the "read the actual error before guessing" discipline applied to embedded.
