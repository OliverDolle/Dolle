...
- `devkit:agent-development` → `references/troubleshooting.md` — its log applies this method to LLM/agent failures
...
- `extensible-architecture.md` — once you've confirmed the root cause, design the fix so the
