...
deterministic and LLM-as-judge assertions (see `devkit:agent-development` → `references/eval-harness-ci.md` §1), and fails
...
See `devkit:agent-development` → `references/eval-harness-ci.md` for the full method.
