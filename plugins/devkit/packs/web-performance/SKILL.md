...
description: >-
  Method for making web pages fast against Core Web Vitals — LCP, CLS, INP (plus TTFB/FCP). Load
  when a page feels slow, before shipping a new page/site, or when asked to optimize load or
  runtime performance. Covers measuring (lab + field), the per-metric fix playbook, and budgets
  for images, fonts, JavaScript, and third parties. Pairs with the ui-ux-design section.
---
