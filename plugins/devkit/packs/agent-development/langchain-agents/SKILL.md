...
description: Practical guide to building tool-using agents with LangChain (chat models, prompts, @tool, tool-calling agents, structured output, memory, streaming). Load when the user wants to create or extend a LangChain agent. For stateful multi-step workflows, use the langgraph-workflows skill instead.
---
...
**LangGraph** (see the `langgraph-workflows` skill); the two compose — LangChain models and
...
Reach for LangGraph (`langgraph-workflows` skill) once you need: explicit branching, retries,
