...
description: A living log of errors encountered while building LangChain/LangGraph agents and their fixes. Consult when you hit an error during agent development; append a new entry whenever you resolve one that isn't listed.
---
